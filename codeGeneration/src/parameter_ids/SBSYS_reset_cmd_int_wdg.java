 ...
 */
public class SBSYS_reset_cmd_int_wdg implements ParamCode {
	 ...
	 */
	public SBSYS_reset_cmd_int_wdg() {
		param = ParamDefaults.SBSYS_reset_cmd_int_wdg;
	}
	 ...
	 */
	public SBSYS_reset_cmd_int_wdg(int enumValue, String idName, String dataType,
	                               String defaultValue) {
